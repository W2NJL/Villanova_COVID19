 ...
 * Return Type  : void
 */
void acemxEnsureCapacity_boolean_T(emxArray_boolean_T *emxArray, int oldNumel)
{
  int newNumel;
  int i;
  void *newData;
 ...
 * Return Type  : void
 */
void acemxEnsureCapacity_creal_T(emxArray_creal_T *emxArray, int oldNumel)
{
  int newNumel;
  int i;
  void *newData;
 ...
 * Return Type  : void
 */
void acemxEnsureCapacity_cuint8_T(emxArray_cuint8_T *emxArray, int oldNumel)
{
  int newNumel;
  int i;
  void *newData;
 ...
 * Return Type  : void
 */
void acemxEnsureCapacity_int32_T(emxArray_int32_T *emxArray, int oldNumel)
{
  int newNumel;
  int i;
  void *newData;
 ...
 * Return Type  : void
 */
void acemxEnsureCapacity_real_T(emxArray_real_T *emxArray, int oldNumel)
{
  int newNumel;
  int i;
  void *newData;
 ...
 * Return Type  : void
 */
void acemxFree_boolean_T(emxArray_boolean_T **pEmxArray)
{
 ...
 * Return Type  : void
 */
void acemxFree_creal_T(emxArray_creal_T **pEmxArray)
{
 ...
 * Return Type  : void
 */
void acemxFree_cuint8_T(emxArray_cuint8_T **pEmxArray)
{
 ...
 * Return Type  : void
 */
void acemxFree_int32_T(emxArray_int32_T **pEmxArray)
{
 ...
 * Return Type  : void
 */
void acemxFree_real_T(emxArray_real_T **pEmxArray)
{
 ...
 * Return Type  : void
 */
void acemxInit_boolean_T(emxArray_boolean_T **pEmxArray, int numDimensions)
{
 ...
 * Return Type  : void
 */
void acemxInit_creal_T(emxArray_creal_T **pEmxArray, int numDimensions)
{
 ...
 * Return Type  : void
 */
void acemxInit_cuint8_T(emxArray_cuint8_T **pEmxArray, int numDimensions)
{
 ...
 * Return Type  : void
 */
void acemxInit_int32_T(emxArray_int32_T **pEmxArray, int numDimensions)
{
 ...
 * Return Type  : void
 */
void acemxInit_real_T(emxArray_real_T **pEmxArray, int numDimensions)
{
...
/*
 * File trailer for ac_feat_emxutil.c
 *
 * [EOF]
 */
