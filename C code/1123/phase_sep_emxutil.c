...
static void emxCopy_real_T(emxArray_real_T **dst, emxArray_real_T * const *src)
{
  ...
  phaseemxEnsureCapacity_real_T(*dst, numElDst);
...
static void emxFreeStruct_cell_wrap_0(cell_wrap_0 *pStruct)
{
  phaseemxFree_real_T(&pStruct->f1);
}
...
static void emxInitStruct_cell_wrap_0(cell_wrap_0 *pStruct)
{
  phaseemxInit_real_T(&pStruct->f1, 2);
}
 ...
 * Return Type  : void
 */
void phaseemxEnsureCapacity_real_T(emxArray_real_T *emxArray, int oldNumel)
{
  int newNumel;
  int i;
  void *newData;
 ...
 * Return Type  : void
 */
void emxFreeMatrix_cell_wrap_0(cell_wrap_0 pMatrix[100])
{
  int i;
  for (i = 0; i < 100; i++) {
 ...
 * Return Type  : void
 */
void phaseemxFree_real_T(emxArray_real_T **pEmxArray)
{
 ...
 * Return Type  : void
 */
void emxInitMatrix_cell_wrap_0(cell_wrap_0 pMatrix[100])
{
  int i;
  for (i = 0; i < 100; i++) {
 ...
 * Return Type  : void
 */
void phaseemxInit_real_T(emxArray_real_T **pEmxArray, int numDimensions)
{
...
/*
 * File trailer for phase_sep_emxutil.c
 *
 * [EOF]
 */
