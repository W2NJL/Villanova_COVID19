...
public class Month3Fragment extends Fragment {
    ...
    private void init(View view) {
        ...
        Month m = currentDate.minusMonths(2).getMonth();
    ...
    private void initDB() {
        ...
        reff.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                String date;
                LocalDate now;
                LocalDate today = currentDate.minusMonths(2);
                int risSum = 0;
                int HRSum = 0;
                int O2Sum = 0;
                int TVSum = 0;
                ...
                LocalDate curMonth = LocalDate.of(currentDate.minusMonths(2).getYear(), currentDate.minusMonths(2).getMonth(), 1);
...
//                            series.appendData(point, true, 1440);
                ...
                if (count == 0) {
                    ...
                    graph.getViewport().setMaxX(4);  //Get RR graph data
