 ...
 * Use the {@link Week3Fragment#newInstance} factory method to
...
public class Week3Fragment extends Fragment {
     ...
     * @return A new instance of fragment Week3Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Week3Fragment newInstance(String param1, String param2) {
        Week3Fragment fragment = new Week3Fragment();
    ...
    private void init(View view) {
        ...
        LocalDate weekToday = currentDate.minusWeeks(3).plusDays(1);
    ...
    private void initDB() {
        ...
        reff.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                String date;
                LocalDate now;
                LocalDate today = currentDate.minusWeeks(2);
                LocalDate weekToday = currentDate.minusWeeks(3).plusDays(1);
                int risSum = 0;
                int HRSum = 0;
                int O2Sum = 0;
