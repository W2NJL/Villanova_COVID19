...
public class Month4Fragment extends Fragment {
    ...
    private void init(View view) {
        ...
        Month m = currentDate.minusMonths(3).getMonth();
    ...
    private void initDB() {
        ...
        reff.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                String date;
                LocalDate now;
                LocalDate today = currentDate.minusMonths(3);
                int risSum = 0;
                int HRSum = 0;
                int O2Sum = 0;
                int TVSum = 0;
                ...
                LocalDate curMonth = LocalDate.of(currentDate.minusMonths(3).getYear(), currentDate.minusMonths(3).getMonth(), 1);
