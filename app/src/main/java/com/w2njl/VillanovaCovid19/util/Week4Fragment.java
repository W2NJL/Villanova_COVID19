 ...
 * Use the {@link Week4Fragment#newInstance} factory method to
...
public class Week4Fragment extends Fragment {
     ...
     * @return A new instance of fragment Week4Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Week4Fragment newInstance(String param1, String param2) {
        Week4Fragment fragment = new Week4Fragment();
    ...
    private void init(View view) {
        ...
        LocalDate weekToday = currentDate.minusWeeks(4).plusDays(1);
    ...
    private void initDB() {
        ...
        reff.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                String date;
                LocalDate now;
                LocalDate today = currentDate.minusWeeks(3);
                LocalDate weekToday = currentDate.minusWeeks(4).plusDays(1);
                int risSum = 0;
                int HRSum = 0;
                int O2Sum = 0;
