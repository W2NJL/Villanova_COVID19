 ...
 * Use the {@link Week5Fragment#newInstance} factory method to
...
public class Week5Fragment extends Fragment {
     ...
     * @return A new instance of fragment Week5Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Week5Fragment newInstance(String param1, String param2) {
        Week5Fragment fragment = new Week5Fragment();
    ...
    private void init(View view) {
        ...
        LocalDate weekToday = currentDate.minusWeeks(5).plusDays(1);
    ...
    private void initDB() {
        ...
        reff.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                String date;
                LocalDate now;
                LocalDate today = currentDate.minusWeeks(4);
                LocalDate weekToday = currentDate.minusWeeks(5).plusDays(1);
                int risSum = 0;
                int HRSum = 0;
                int O2Sum = 0;
