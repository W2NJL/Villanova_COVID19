    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.actionRate:
                Intent intent = new Intent(PhaseView.this, SettingsActivity.class);
            ...
            case R.id.actionLogout:
                ...
                Paper.init(this);
                Paper.book().destroy();
                startActivity(new Intent(PhaseView.this, LoginActivity.class));
                break;
            case R.id.actionUser:
                startActivity(new Intent(PhaseView.this, UserProfile.class));
                break;
