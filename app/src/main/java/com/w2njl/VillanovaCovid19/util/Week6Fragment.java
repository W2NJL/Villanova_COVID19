 ...
 * Use the {@link Week6Fragment#newInstance} factory method to
...
public class Week6Fragment extends Fragment {
     ...
     * @return A new instance of fragment Week6Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static Week6Fragment newInstance(String param1, String param2) {
        Week6Fragment fragment = new Week6Fragment();
    ...
    private void init(View view) {
        ...
        LocalDate weekToday = currentDate.minusWeeks(6).plusDays(1);
    ...
    private void initDB() {
        ...
        reff.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                String date;
                LocalDate now;
                LocalDate today = currentDate.minusWeeks(5);
                LocalDate weekToday = currentDate.minusWeeks(6).plusDays(1);
                int risSum = 0;
                int HRSum = 0;
                int O2Sum = 0;
